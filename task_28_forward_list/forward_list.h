...
{
    fwd_list_iterator() : m_current (nullptr) {}

    fwd_list_iterator(my::fwd_list_Node<T>* ptr) : m_current (ptr) {}
...
public:
    ...
    forward_list(const forward_list& rhs) : head(nullptr)
    {
    ...
    forward_list(forward_list&& rhs) : head(nullptr)
    {
        rhs.swap(*this);
    }
